...
void ColorMaker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorMaker::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorMaker::currentTime)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ColorMaker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ColorMaker.data,
      qt_meta_data_ColorMaker,  qt_static_metacall, nullptr, nullptr}
};
